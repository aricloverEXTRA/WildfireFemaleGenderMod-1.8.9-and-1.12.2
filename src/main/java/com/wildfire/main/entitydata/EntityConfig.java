...
public class EntityConfig {
	...
	protected float pButtocksSize = Configuration.BUTTOCKS_SIZE.getDefault();
    protected boolean breastPhysics = Configuration.BREAST_PHYSICS.getDefault();
    protected boolean buttocksPhysics = Configuration.BUTTOCKS_PHYSICS.getDefault();
    ...
    protected final ButtocksPhysics lButtocksPhysics, rButtocksPhysics;
    ...
    protected EntityConfig(UUID uuid) {
        ...
        this.buttocks = new Buttocks();
        lBreastPhysics = new BreastPhysics(this);
        rBreastPhysics = new BreastPhysics(this);
        lButtocksPhysics = new ButtocksPhysics(this);
        rButtocksPhysics = new ButtocksPhysics(this);
    }
    ...
    public void readFromStack(@NotNull ItemStack chestplate) {
        ...
        buttocks.updateCleavage(fromComponent.cleavage());
        buttocks.updateOffsets(fromComponent.offsets());
    ...
    public @NotNull Buttocks getButtocks() {
        return buttocks;
    }
    ...
    public boolean hasButtocksPhysics() {
        return buttocksPhysics;
    }
    ...
    public @NotNull ButtocksPhysics getLeftButtocksPhysics() {
        return lButtocksPhysics;
    }
    public @NotNull ButtocksPhysics getRightButtocksPhysics() {
        return rButtocksPhysics;
    }
    ...
    @Environment(EnvType.CLIENT)
    public void tickButtocksPhysics(@NotNull LivingEntity entity) {
        IGenderArmor armor = WildfireHelper.getArmorConfig(entity.getEquippedStack(EquipmentSlot.CHEST));

        getLeftButtocksPhysics().update(entity, armor);
        getRightButtocksPhysics().update(entity, armor);
    }
