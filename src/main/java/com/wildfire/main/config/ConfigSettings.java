...
public class ConfigSettings {
    ...
    // Breast-related settings
    public static float breastSize = 50.0F; // Default breast size
    public static float bounceMultiplier = 1.0F; // Default bounce multiplier
    public static float separation = 0.0F; // Default separation between breasts
    public static float depth = -5.0F; // Default depth setting
    public static float height = 0.0F; // Default height adjustment
    public static float rotation = 5.0F; // Default rotation angle
    public static float breastsOffsetX = 0.5F; // X-axis offset for breasts
    public static float breastsOffsetY = -1.5F; // Y-axis offset for breasts
    public static float breastsOffsetZ = -2.0F; // Z-axis offset for breasts
    public static float breastsCleavage = 1.0F; // Default cleavage value
    public static boolean breastsUniboob = false; // Default uniboob state
