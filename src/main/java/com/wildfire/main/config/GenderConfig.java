...
public class GenderConfig {
    ...
    public static void loadConfig(FMLPreInitializationEvent event) {
        ...
        try {
            ...
            localPlayerSettings.breastSize = config.getFloat("BreastSize", "General", 50.0F, 0.0F, 100.0F, "Default breast size");
            localPlayerSettings.bounceMultiplier = config.getFloat("BounceMultiplier", "General", 1.0F, 0.0F, 3.0F, "Default bounce multiplier");
            localPlayerSettings.separation = config.getFloat("Separation", "General", 0.0F, -10.0F, 10.0F, "Default separation");
            localPlayerSettings.depth = config.getFloat("Depth", "General", -5.0F, -10.0F, 0.0F, "Default depth");
            localPlayerSettings.height = config.getFloat("Height", "General", 0.0F, -10.0F, 10.0F, "Default height");
            localPlayerSettings.rotation = config.getFloat("Rotation", "General", 5.0F, 0.0F, 10.0F, "Default rotation");
    ...
    public static void saveConfig() {
        try {
            ...
            config.get("General", "Depth", -5.0F).set(localPlayerSettings.depth);
            config.get("General", "Height", 0.0F).set(localPlayerSettings.height);
            config.get("General", "Rotation", 5.0F).set(localPlayerSettings.rotation);
