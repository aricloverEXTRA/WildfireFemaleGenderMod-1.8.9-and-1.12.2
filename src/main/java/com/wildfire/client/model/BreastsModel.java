...
public class BreastsModel extends ModelBase {
    ...
    public BreastsModel() {
        ...
        // Left Breast (Triangular Shape)
        this.leftBreast = new ModelRenderer(this, 24, 0);
        this.leftBreast.addBox(-1.5F, -1.5F, -2.0F, 3, 3, 2);
        this.leftBreast.setRotationPoint(-1.5F, 10.0F, -2.0F);

        // Right Breast (Triangular Shape)
        this.rightBreast = new ModelRenderer(this, 24, 0);
        this.rightBreast.addBox(-1.5F, -1.5F, -2.0F, 3, 3, 2);
        this.rightBreast.setRotationPoint(1.5F, 10.0F, -2.0F);
    ...
    public void render(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
        if (shouldRenderBreasts(entity)) {
            System.out.println("Rendering breasts model...");
            ...
            System.out.println("Breasts model will not render for this entity.");
        }
    }
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn) {
        ...
        this.leftBreast.setRotationPoint(-1.5F, 10.0F + breastPhysics.getPositionY(), -2.0F);
        this.rightBreast.setRotationPoint(1.5F, 10.0F + breastPhysics.getPositionY(), -2.0F);
    }
    ...
    public boolean shouldRenderBreasts(Entity entity) {
        if (entity instanceof EntityPlayer) {
            ...
            System.out.println("Checking gender for rendering: " + gender);
