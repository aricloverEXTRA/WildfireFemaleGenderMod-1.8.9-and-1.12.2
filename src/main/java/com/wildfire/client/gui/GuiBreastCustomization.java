...
import com.wildfire.client.gui.screen.TransparentButton;
...
public class GuiBreastCustomization extends GuiScreen implements ISlider {
    ...
    private TransparentButton genderButton;
    ...
    public void initGui() {
        ...
        genderButton = new TransparentButton(10, centerX + (guiWidth - 200) / 2, centerY + 20, 200, 20, getGenderDisplayString());
