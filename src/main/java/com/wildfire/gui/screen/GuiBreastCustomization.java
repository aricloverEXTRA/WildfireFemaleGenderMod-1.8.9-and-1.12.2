...
public class GuiBreastCustomization extends GuiScreen implements GuiSlider.ISlider {
    ...
    public void initGui() {
        ...
        this.heightSlider = new GuiSlider(3, sliderX + smallSliderWidth + 3 + 1, sliderY + spacing - 1, smallSliderWidth, sliderHeight,
                prefixFromKey("wildfire_gender.wardrobe.slider.height"), "", -10.0D, 10.0D, -this.settings.breastsOffsetY * 3f, false, true, this);
    ...
    public void onChangeSliderValue(GuiSlider slider) {
        switch (slider.id) {
            ...
            case 2:
                ...
                break;
            case 3:
                this.settings.breastsOffsetY = -(float) slider.getValue() / 3f;
                break;
            case 4:
